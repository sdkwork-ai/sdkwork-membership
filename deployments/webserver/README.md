...
Module `sdkwork-membership` · runtime code `membership` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `membership-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `membership-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `membership-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `membership-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `membership.sdkwork.com` | 443 ssl + 80 |
