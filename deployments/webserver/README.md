...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `membership-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `membership-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `membership-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `membership.sdkwork.com` | 443 ssl + 80 |
