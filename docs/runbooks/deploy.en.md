# Runbook — sdkwork-membership deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-membership-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-membership/bundle`, loads the image, starts
